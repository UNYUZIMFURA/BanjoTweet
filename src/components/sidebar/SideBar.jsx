...
const SideBar = () => {
  return (
    <div className="sm:justify-normal sm:gap-[1.97rem] fixed bottom-0 w-full flex items-center justify-between px-4 py-3 sm:static min-[1003px]:top- min-[1003px]:left- sm:flex-col sm:w-[4.5rem] xl:w-[16.4rem] sm:border-r sm:border-custom sm:py-3 xl:items-start text-white">
