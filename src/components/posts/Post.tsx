        ...
        <div className="flex cursor-pointer flex-col border-b border-r border-custom text-white hover:bg-[#0a0a0a]">
            ...
            <div className="ml-[12%] flex w-[85%] items-center justify-between py-4 text-skin-secondary">
                ...
                <div className="group flex items-center gap-[3px]">
                    <div className="rounded-full p-1 group-hover:bg-[#00BA7C1A]">
                        <svg
                            ...
                            aria-hidden="true"
                            width="20"
                            className="fill-[rgb(113,118,123)] group-hover:fill-[#00BA7C]"
                        >
                            <g>
                    ...
                    <span className="text-[13px] group-hover:text-[#00BA7C]">
                        {retweets}K
                    </span>
                </div>
                <div className="group flex items-center gap-[3px]">
                    <svg
                        ...
                        aria-hidden="true"
                        width="20"
                        className="fill-[rgb(113,118,123)] group-hover:fill-[#F91880]"
                    >
                        <g>
                ...
                <div className="flex items-center gap-1">
                    <div className="group rounded-full p-1 hover:bg-[#1D9BF01A]">
                        <svg
                            viewBox="0 0 24 24"
                            aria-hidden="true"
                            width="20"
