                ...
                >
                    <div className="rounded-full p-1 group-hover:bg-[#00BA7C1A]">
                        <svg
                            ...
                            aria-hidden="true"
                            width="20"
                            className={`fill-[rgb(113,118,123)] transition ease-in-out ${retweeted ? "fill-[#00BA7C]" : ""} `}
                        >
                            <g>
                ...
                >
                    <div className="rounded-full p-1 group-hover:bg-[#00BA7C1A]">
                        <svg
                            ...
                            aria-hidden="true"
                            width="20"
                            className={`fill-[rgb(113,118,123)] transition ease-in-out ${liked ? "fill-[#F91880]" : ""}`}
                        >
                            <g>
                ...
                <div className="flex items-center gap-1">
                    ...
                    >
                        <svg
                            ...
                            aria-hidden="true"
                            width="20"
                            className={`fill-[rgb(113,118,123)] transition ease-in-out ${bookmarked ? "fill-[#1D9BF0]" : ""}`}
                        >
                            <g>
                    ...
                    >
                        <svg
                            ...
                            aria-hidden="true"
                            width="20"
                            className={`fill-[rgb(113,118,123)] transition ease-in-out ${uploaded ? "fill-[#1D9BF0]" : ""} `}
                        >
                            <g>
